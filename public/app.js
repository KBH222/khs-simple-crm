...
<div class="job-item job-${job.title.toLowerCase()}" style="background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 6px; padding: 12px 5px; margin: 4px 0 2px 0; font-size: 16.1px; width: 130px; transition: background-color 0.2s;"
